...
import org.catmint.context.database.DatabaseTypeRegistry;
...
public final class MySQLComQueryPacketExecutor implements QueryCommandExecutor {
    ...
    public MySQLComQueryPacketExecutor(final MySQLComQueryPacket comQueryPacket) {
        CatmintSQLParserEngine.newInstance( DatabaseTypeRegistry.getActualDatabaseType( DatabaseTypeRegistry.DEFAULT_DATABASE_TYPE ) ).parse( comQueryPacket.getSql() );
